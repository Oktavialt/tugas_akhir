...
class Reservasi extends Controller
{
    ...
    public function update($id_reservasi)
    {
        ...
        if($status == 'Dalam Proses') {
            ...
            $pesanStatus = 'terkonfirmasi. Silahkan datang 15 menit sebelum tindakan treatment dimulai, jika berhalangan hadir segera hubungi Admin. Terimkaasih';
        } else if($status == 'Selesai') {
            $pesanStatus = 'selesai. Terimakasih atas kedatangan dan kepercayaan anda untuk melakukan treatment di klinik Adiva Beauty Skin. Kami tunggu kedatangan anda selanjutnya';
        } else if($status == 'Batal') {
            $pesanStatus = 'dibatalkan. Mohon maaf atas ketidaknyamanan akan pelayanan kami. Terimakasih';
        }
        // set jadwal
        ...
        $message = "Halo " . $user['nama_lengkap'] . "! Reservasi treatment anda pada tanggal " . date('d-m-Y', strtotime($reservasi['tgl_reservasi'])) . " sesi " . $reservasi['sesi_reservasi'] . " telah " . $pesanStatus . ".\n- Adiva Beauty Skin -";
