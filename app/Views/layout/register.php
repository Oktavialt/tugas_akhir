    ...
    <script>
        function validatePassword() {
            ...
            if (nomor_telepon.length > 13) {
                alert("Nomor Telepon harus terdiri dari 13 karakter!");
                return false;
            }

            if (nomor_telepon.length < 11) {
                alert("Nomor Telepon harus terdiri dari minimal 11 karakter!");
                return false;
            }
                            ...
                            <div class="card-body p-5">
                                ...
                                <form action='<?= base_url('simpanRegister') ?>' method="post" onsubmit="return validatePassword()">
                                    <div class="form-outline mb-4">
                                        ...
                                        <input type="text" id="nama_lengkap" class="form-control" placeholder="Masukkan Nama Lengkap Anda" name="nama" autofocus required oninvalid="this.setCustomValidity('Masukkan Nama Lengkap Anda')" oninput="this.setCustomValidity('Masukkan Nama Lengkap Anda')" onchange="this.setCustomValidity('')" />
                                    </div>

                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="username">Username
                                        </label>
                                        <input type="text" id="username" class="form-control" placeholder="Masukkan Username Anda" name="username" autofocus required oninvalid="this.setCustomValidity('Masukkan Username Anda')" oninput="this.setCustomValidity('Masukkan Username Anda')" onchange="this.setCustomValidity('')" />
                                    </div>

                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="password">Password</label>
                                        <div class="password-wrapper">
                                            <input type="password" id="password" class="form-control" placeholder="Masukkan Password Anda" name="password" autofocus required onchange="this.setCustomValidity('')" />
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <div class="password-wrapper">
                                            <input type="password" id="password-confirm" class="form-control" placeholder="Konfirmasi Password Anda" name="password-confirm" autofocus required onchange="this.setCustomValidity('')" />
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <input type="text" id="alamat" class="form-control" placeholder="Masukkan Alamat Anda" name="alamat" autofocus required oninvalid="this.setCustomValidity('Masukkan Alamat Anda')" oninput="this.setCustomValidity('Masukkan Alamat Anda')" onchange="this.setCustomValidity('')" />
                                    </div>
