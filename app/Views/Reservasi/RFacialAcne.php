...
<body>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="/Detail/FacialAntiAcne">Facial Anti Acne</a></li>
                ...
                <div class="flex flex-col p-5 bg-white shadow-lg relative max-w-[592px]">
                    ...
                    <div class="container">
                        <div class="row flex shadow">
                            <div class="col-4 p-0">
                                <img src="/img/facial anti acne.png" class="img-fluid" alt="...">
                            </div>
                            <div class="col-8 my-3">
                                <h4 class="text-base md:text-lg text-gray-800 font-bold">Facial Anti Acne</h4>
                                <p class="text-sm md:text-base mb-auto line-clamp-4">Prosedur facial yang berfungsi untuk mengatasi jerawat, mencerahkan kulit wajah dan menghancurkan efek radikal bebas yang menjadi penyebab kulit kusam sehingga kulit wajah semakin terlihat bersih dan putih berseri.</p><strong>Rp. 75.000</strong>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex flex-col p-5 bg-white shadow-lg relative max-w-[592px]">
                        ...
                        <div class="flex mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" placeholder="Facial Anti Acne" aria-label="Disabled input example" disabled>
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">Total Yang Harus Dibayar</label>
                                <input class="form-control" type="text" placeholder="Rp 75.000" aria-label="Disabled input example" disabled>
                            </div>
                        </div>
