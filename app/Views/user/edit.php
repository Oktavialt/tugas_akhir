    ...
    <form method="post" action="<?= base_url('user/update/' . $user['user_id']) ?>">
      ...
      <div class="card-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="nama_lengkap" id="nama_lengkap" placeholder="Masukkan Nama Lengkap Anda" value="<?= $user['nama_lengkap'] ?>" autofocus required>
        </div>
        <div class="form-group">
          <label for="username">Username</label>
          <input type="text" class="form-control" name="username" id="username" placeholder="Masukkan Username Anda" value="<?= $user['username'] ?>" autofocus required>
        </div>
        <div class="form-group">
          <label for="alamat">Alamat</label>
          <input type="text" class="form-control" name="alamat" id="alamat" placeholder="Masukkan Alamat Anda" value="<?= $user['alamat'] ?>" autofocus required>
        </div>
        <div class="form-group">
          <label for="nomor_telepon">No. Telepon</label>
          <input type="text" class="form-control" name="nomor_telepon" id="nomor_telepon" placeholder="Masukkan Nomor Telepon Anda" value="<?= $user['nomor_telepon'] ?>" autofocus required>
        </div>
        <div class="form-group">
