    ...
    <div class="card mb-4">
        <form method="post" action="<?= base_url('Admin/Reservasi/update') . '/'. $dataReservasi['id_reservasi'] ?>">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="tgl_reservasi">Tanggal Treatment</label>
                    <input type="text" class="form-control" name="tgl_reservasi" id="tgl_reservasi" placeholder="Tanggal Treatment" autofocus readonly disabled value="<?= $dataReservasi['tgl_reservasi'] ?>">
                </div>
                <div class="form-group">
                    <label for="sesi_reservasi">Sesi Treatment</label>
                    <input type="text" class="form-control" name="sesi_reservasi" id="sesi_reservasi" placeholder="Sesi Treatment" autofocus readonly disabled value="<?= $dataReservasi['sesi_reservasi'] ?>">
                </div>
                <div class="form-group">
                    <label for="total">Total Tagihan</label>
                    <input type="text" class="form-control" name="total" id="total" placeholder="Total Tagihan" autofocus readonly disabled value="<?= $dataReservasi['total'] ?>">
                </div>
                <div class="form-group">
